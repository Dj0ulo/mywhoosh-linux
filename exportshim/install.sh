#!/usr/bin/env bash
# Put the export shim where the kick in ../fakesensor/fakebonjour.c looks for it.
#
...
# fakebonjour derives this path from libmono's own module path at run time, so
