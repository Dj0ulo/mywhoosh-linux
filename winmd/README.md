...
Measured on MyWhoosh 6.1.2, one prefix, `WINEDEBUG=+loaddll`:
...
working rather than as anything pointing here. That happened once —
`ServiceUuids` returning `IReadOnlyList<Guid>` where the game's
